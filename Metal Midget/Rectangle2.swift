class Rectangle2 {
    ...
    init() {
        let TOP_LEFT     = Vertex(x: -1.0, y:  0.5, z:  0.0, tx: 0.0, ty: 0.0)
        let TOP_RIGHT    = Vertex(x:  0.0, y:  0.5, z:  0.0, tx: 1.0, ty: 0.0)
        let BOTTOM_LEFT  = Vertex(x: -1.0, y: -0.5, z:  0.0, tx: 0.0, ty: 1.0)
        let BOTTOM_RIGHT = Vertex(x:  0.0, y: -0.5, z:  0.0, tx: 1.0, ty: 1.0)
